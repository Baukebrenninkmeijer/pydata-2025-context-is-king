...
image: "../img/context_window_comparison_2025.png"
...
open-graph:
  ...
  description: "Experiments comparing long context windows vs RAG across GPT, Claude, and Gemini. When to skip RAG, the 100k token performance cliff, and why reranking may not matter anymore."
  image: "../img/context_window_comparison_2025.png"
twitter-card:
  title: "Your RAG Pipeline is Probably Overkill"
...
![Gemini Flash Lite, Flash, and Pro throughput across context sizes, showing a clean three-tier speed differentiation.](../results/scaling/analysis/gemini_only_analysis/throughput_vs_context_size.png){#fig-gemini}
